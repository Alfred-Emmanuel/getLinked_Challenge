...
export default function Home() {
  ...
  return (
    <div className="md-relative overflow-x-hidden">
      ...
      />
      <main className="pl-0 md:pl-[7%] mt-28 md:mt-36">
        ...
        <section
          id="faqs"
          className="text-center mt-20 md:text-left md:mt-32 mb-10 md:mr-[6%] relative"
        >
          <Image
            src="/star(4).png"
            alt="fifth star"
        ...
        <section
          id="timeline"
          className="text-center mt-9 mb-16 md:mt-28 md:mb-20 relative"
        >
        ...
        <section className="text-center md:text-left mt-20 mb-5 md:mt-28 md:mb-20 relative">
          <Image
            src="/Purple-Lens-Flare-PNG.png"
            alt="the globe"
            width={100}
