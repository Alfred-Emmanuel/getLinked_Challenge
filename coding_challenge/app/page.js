...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (hasLoadedBefore) {
      ...
      setTimeout(() => {
        setShowMainContent(true); // Show main content after a delay (e.g., 3000 milliseconds)
      }, 7500);
    }
  }, []);
          ...
          <section className=" mt-8 lg:mt-0 text-center lg:text-left relative ">
            ...
            <div className="lg:mt-[3%] lg:flex ">
              ...
              <h2 className="text-4xl">
                ...
                <p
                  ref={commonRefs[1]}
                  className="text-[0.7rem] w-[60%] text-center mx-auto pt-1 mb-6 lg:pt-0 lg:mx-0 lg:text-left lg:text-[1rem] lg:mb-10 lg:mt-5 lg:w-[60%]"
                >
              ...
              <div className=" lg:w-[50%] flex items-center">
                <div>
                  ...
                  <p className="w-[80%] mb-5 mx-auto text-[0.78rem] lg:text-[1rem] font-normal lg:font-semibold lg:mb-0 lg:mx-0 lg:w-[60%]">
                    We&apos;ve got answers to the questions that you might want
                    to ask about{" "}
