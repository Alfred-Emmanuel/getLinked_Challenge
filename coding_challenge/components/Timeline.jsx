...
const Timeline = () => {
  return (
    <>
      <section className=" lg:px-24 px-8 relative">
        <div className="flex flex-col items-center justify-center py-12">
          <Slide direction="down" triggerOnce={true}>
            <h2 className="text-2xl mb-3 md:text-3xl font-bold lg:mb-5">
              Timeline
            </h2>
            <p className=" text-[0.8rem] w-[80%] mx-auto mb-12 lg:mb-0 md:text-[1rem] md:mb-2 lg:w-[70%]">
          ...
          <div className="flex flex-col lg:grid grid-cols-9 mx-auto lg:p-2 text-blue-50">
            ...
            <div className="flex flex-row-reverse lg:contents">
              <div className=" col-start-1 col-end-5 lg:p-4 lg:my-4 lg:ml-auto">
                <Slide delay={200} triggerOnce={true}>
                  <h3 className="font-semibold md:text-lg lg:text-right text-left mb-1 text-primary-color">
                    Hackathon Announcement
                  </h3>
                  <p className="leading-tight text-justify lg:text-right text-sm md:text-[1rem]">
            ...
            <div className="flex lg:contents">
              ...
              <div className=" col-start-6 col-end-10 lg:p-4 pt-3 lg:pt-0 my-4 lg:mr-auto shadow-lg">
                <Slide direction="right" triggerOnce={true}>
                  <h3 className="font-semibold md:text-lg lg:text-left text-left mb-1 text-primary-color">
                    Team Registation begins
                  </h3>
                  <p className="leading-tight text-justify text-sm md:text-[1rem] ">
            ...
            <div className="flex flex-row-reverse lg:contents lg:text-right">
              <div className=" col-start-1 col-end-5 lg:p-4 my-4 lg:ml-auto">
                <Slide direction="left" delay={400} triggerOnce={true}>
                  <h3 className="font-semibold md:text-lg text-left lg:text-right mb-1 text-primary-color">
                    Team Registration ends
                  </h3>
                  <p className="leading-tight lg:text-right text-left text-sm md:text-[1rem] ">
            ...
            <div className="flex lg:contents">
              ...
              <div className=" col-start-6 col-end-10 lg:p-4 my-4 lg:mr-auto shadow-lg">
                <Slide direction="right" triggerOnce={true}>
                  <h3 className="font-semibold md:text-lg mb-1 text-left text-primary-color">
                    Announcement of the accepted teams and ideas
                  </h3>
                  <p className="leading-tight text-left text-sm md:text-[1rem] ">
            ...
            <div className="flex flex-row-reverse lg:contents">
              <div className=" col-start-1 col-end-5 lg:p-4 my-4 ml-auto">
                <Slide direction="left" triggerOnce={true}>
                  <h3 className="font-semibold md:text-lg mb-1 lg:text-right text-left text-primary-color">
                    Getlinked Hackathon 1.0 Officially Begins
                  </h3>
                  <p className="leading-tight lg:text-right text-justify text-sm md:text-[1rem] ">
            ...
            <div className="flex lg:contents">
              ...
              <div className=" col-start-6 col-end-10 lg:p-4 my-4 mr-auto shadow-lg">
                <Slide triggerOnce={true} direction="right">
                  <h3 className="font-semibold md:text-lg text-left mb-1 text-primary-color">
                    Demo Day
                  </h3>
                  <p className="leading-tight text-left text-sm text-[1rem] ">
